...
ruleset=规则,https://raw.githubusercontent.com/qjlxh/xxxx/main/wg.list
...
ruleset=字节跳动,https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/Ruleset/.list
ruleset=全球直连,[]GEOIP,CN,no-resolve
ruleset=节点代理,[]FINAL



custom_proxy_group=节点选择`select`[]自动选择`[]负载均衡`[]字节跳动`[]中国`[]节能`[]规则`[]莱垠`.*`[]DIRECT
...
custom_proxy_group=规则`url-test`(🇺🇸|美国|US|🇨🇦|加拿大|CA)`http://www.gstatic.com/generate_204`180,,50
